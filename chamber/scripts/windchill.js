...
// Function to get the forecast for each day at 12:00:00
function getDailyNoonForecasts(data) {
    ...
    // For each date, find the forecast closest to 12:00:00
    for (const date in forecastMap) {
        ...
        // If we found a noon forecast, add it to the daily forecasts
        if (noonForecast) {
...
function displayForecast(data) {
    const forecasts = getDailyNoonForecasts(data);
